package com.walmart.vertx.cluster;
  ...
  public static void main(String[] args) {
    ...
    Vertx.clusteredVertx(options, vertxAsyncResult -> {
      if (vertxAsyncResult.succeeded()) {
        ...
        vertxAsyncResult.result().deployVerticle("com.walmart.vertx.cluster.PublisherVerticle", deploymentOptions, res -> {
          if (res.succeeded()) {
  ...
  public void start() throws Exception {
   ...
   // System.out.println("JVM Name = " + jvmName);
    ...
    vertx.setPeriodic(5000, ar -> {
      System.out.println("Publisher PID  = " + pid + " Thread = " + Thread.currentThread().getName());
      //publish message
