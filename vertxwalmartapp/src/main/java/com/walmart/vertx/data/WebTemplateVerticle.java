package com.walmart.vertx.data;
...
//connect with Mongo db
    JsonObject dbConfig = new JsonObject().put("db_name", "testmydb");
    ...
    //urls and database interaction ; non blocking;
