...
public class VertxUnitTest {
  ...
  public void run() {
    ...
    TestSuite suite = TestSuite.create("com.walmart.vertx.VertxUnitTest");
...
//    });
    suite.test("some_test2", context -> {
      ...
      vertx.deployVerticle("com.walmart.vertx.MainVerticle", context.asyncAssertSuccess(deploymentID -> {
